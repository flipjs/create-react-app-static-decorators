...
export class AdvisoriesPanel extends Component {
  constructor (props) {
    super(props)
  ...
  loadFormView = () => {
    this.props.router.push('advisories/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.advisories} title={this.props.title} color='primary' center>
          <PanelActions>
...
AdvisoriesPanel.displayName = NAME
AdvisoriesPanel.propTypes = propTypes
AdvisoriesPanel.defaultProps = defaultProps

export default withRouter(observer(AdvisoriesPanel))
