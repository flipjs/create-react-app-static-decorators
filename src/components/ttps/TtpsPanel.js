...
import TtpsTable from '../ttps/TtpsTable'
import { ICONS } from '../../constants'
import { secureComponent } from '../../decorators'

const NAME = 'TtpsPanel'
...
export class TtpsPanel extends Component {
  constructor (props) {
    super(props)
  ...
  loadFormView = () => {
    this.props.router.push('ttps/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.ttps} title={this.props.title} color='primary' center>
          <PanelActions>
...
TtpsPanel.displayName = NAME
TtpsPanel.propTypes = propTypes
TtpsPanel.defaultProps = defaultProps

export default withRouter(observer(TtpsPanel))
