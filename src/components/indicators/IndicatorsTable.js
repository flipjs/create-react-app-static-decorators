...
export class IndicatorsTable extends Component {
  handleSelect = (row) => {
...
IndicatorsTable.displayName = NAME
IndicatorsTable.propTypes = propTypes

export default withRouter(observer(IndicatorsTable))
