...
import AdvisoryCategoriesPanel from '../advisory-categories/AdvisoryCategoriesPanel'
import SelectedRecord from '../shared/SelectedRecord'

const NAME = 'AdvisoryCategoriesSection'
...
export class AdvisoryCategoriesSection extends Component {
...
AdvisoryCategoriesSection.displayName = NAME
AdvisoryCategoriesSection.propTypes = propTypes
AdvisoryCategoriesSection.defaultProps = defaultProps

export default withRouter(observer(['stores'], AdvisoryCategoriesSection))
