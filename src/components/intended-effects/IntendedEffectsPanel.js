...
import IntendedEffectsTable from '../intended-effects/IntendedEffectsTable'
import { ICONS } from '../../constants'
import { secureComponent } from '../../decorators'

const NAME = 'IntendedEffectsPanel'
...
export class IntendedEffectsPanel extends Component {
  constructor (props) {
    super(props)
  ...
  loadFormView = () => {
    this.props.router.push('intendedEffects/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.intendedEffects} title={this.props.title} color='primary' center>
          <PanelActions>
        ...
        <PanelBody>
          {store.isFetching ? (
            ...
            <div>
              <IntendedEffectsTable store={store} />
...
IntendedEffectsPanel.displayName = NAME
IntendedEffectsPanel.propTypes = propTypes
IntendedEffectsPanel.defaultProps = defaultProps

export default withRouter(observer(IntendedEffectsPanel))
