...
const NAME = 'VulnerabilitiesPanel'
...
export class VulnerabilitiesPanel extends Component {
  constructor (props) {
    super(props)
  ...
  loadFormView = () => {
    this.props.router.push('vulnerabilities/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.vulnerabilities} title={this.props.title} color='primary' center>
          <PanelActions>
        ...
        <PanelBody>
          {store.isFetching ? (
            ...
            <div>
              <VulnerabilitiesTable store={store} />
...
VulnerabilitiesPanel.displayName = NAME
VulnerabilitiesPanel.propTypes = propTypes
VulnerabilitiesPanel.defaultProps = defaultProps

export default withRouter(observer(VulnerabilitiesPanel))
