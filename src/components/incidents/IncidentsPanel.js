...
export class IncidentsPanel extends Component {
  constructor (props) {
    super(props)
  ...
  loadFormView = () => {
    this.props.router.push('incidents/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.incidents} title={this.props.title} color='primary' center>
          <PanelActions>
...
IncidentsPanel.displayName = NAME
IncidentsPanel.propTypes = propTypes
IncidentsPanel.defaultProps = defaultProps

export default withRouter(observer(IncidentsPanel))
