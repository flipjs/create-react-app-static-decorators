...
import ObservablesPanel from '../observables/ObservablesPanel'
import SelectedRecord from '../shared/SelectedRecord'

const NAME = 'ObservablesSection'
...
export class ObservablesSection extends Component {
      ...
      <div className='row'>
        {((!store.isEmpty) || (store.isEmpty && !store.isSelected)) &&
          <div className={store.isSelected ? halfGrid : fullGrid}>
            <ObservablesPanel title={this.props.title} store={store} actionsDisabled={this.props.actionsDisabled} />
          </div>
        }
        {store.isSelected &&
...
ObservablesSection.displayName = NAME
ObservablesSection.propTypes = propTypes
ObservablesSection.defaultProps = defaultProps

export default withRouter(observer(['stores'], ObservablesSection))
