...
export class UsersPanel extends Component {
  ...
  loadFormView = () => {
    this.props.router.push('users/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.users} title={this.props.title} color='primary' center>
          <PanelActions>
...
UsersPanel.displayName = NAME
UsersPanel.propTypes = propTypes
UsersPanel.defaultProps = defaultProps

export default withRouter(observer(UsersPanel))
