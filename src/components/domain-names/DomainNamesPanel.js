...
import DomainNamesTable from '../domain-names/DomainNamesTable'
import { ICONS } from '../../constants'
import { secureComponent } from '../../decorators'

const NAME = 'DomainNamesPanel'
...
export class DomainNamesPanel extends Component {
  constructor (props) {
    super(props)
  ...
  loadFormView = () => {
    this.props.router.push('domain_names/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.domainNames} title={this.props.title} color='primary' center>
          <PanelActions>
...
DomainNamesPanel.displayName = NAME
DomainNamesPanel.propTypes = propTypes
DomainNamesPanel.defaultProps = defaultProps

export default withRouter(observer(DomainNamesPanel))
