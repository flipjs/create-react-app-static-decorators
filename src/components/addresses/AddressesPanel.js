...
export class AddressesPanel extends Component {
  constructor (props) {
    super(props)
  ...
  loadFormView = () => {
    this.props.router.push('addresses/new')
  }
  ...
  render () {
    ...
    return (
      <Panel id={NAME} theme={this.props.theme}>
        <PanelHeader icon={ICONS.addresses} title={this.props.title} color='primary' center>
          <PanelActions>
...
AddressesPanel.displayName = NAME
AddressesPanel.propTypes = propTypes
AddressesPanel.defaultProps = defaultProps

export default withRouter(observer(AddressesPanel))
